...
```{r}
nchsCol <- c("Year", "birmon", "cntyres", "stateres", "countyBirths", "stateBirths")
...
# Copying data frame in case of errors
nchsData3 <- nchsData2

setnames(nchsData2, old = nchsCol, new = newColnames)
...
```{r}
allBirthData <- rbind(nchsData2, wonderData2)
```
